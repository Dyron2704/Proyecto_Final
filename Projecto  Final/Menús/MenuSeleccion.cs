...
namespace Projecto__Final.Menús
{
    internal class MenuSeleccion
    {
        ...
        public MenuSeleccion(Texture2D fondoNormal, Texture2D texBoton, Texture2D texBotonHover, SpriteFont fuente)
        {
            ...
            _botones.Add(new Boton(texBoton, texBotonHover, fuente, new Vector2(posXCentrada, 150), "Crear Partida"));
            _botones.Add(new Boton(texBoton, texBotonHover, fuente, new Vector2(posXCentrada, 300), "Cargar Partida"));
